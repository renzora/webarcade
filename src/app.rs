...
pub struct App {
    ...
    decorations: bool,
    router: Router,
    frontend: Option<&'static Dir<'static>>,
}
...
impl App {
    ...
    pub fn frontend(mut self, dir: &'static Dir<'static>) -> Self {
        ...
        let webview = WebViewBuilder::with_web_context(&mut web_context)
            ...
            .with_initialization_script(&format!(
                "document.addEventListener('DOMContentLoaded', () => {{ \
                    ...
                    meta.content = \"default-src 'self' app: ; script-src 'self' app: 'unsafe-inline'; style-src 'self' app: 'unsafe-inline'; img-src 'self' app: data: blob:; font-src 'self' app: data:; connect-src 'self' app:\"; \
